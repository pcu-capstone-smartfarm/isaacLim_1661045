...
<script>
    ...
    async function closeClick(){
        $a = document.getElementById("sliderOverlay").className="duration-500 ease-in-out opacity-0";
        await sleep(500);
        $a = document.getElementById("sliderOverlay").className="hidden";
    }
</script>
<div id="sliderOverlay" class="fixed inset-0 overflow-hidden" aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
      ...
      <div id="slideOver" class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
        ...
        <div id="closeBtn" class="pointer-events-auto relative w-screen max-w-md">
          ...
          <div class="absolute top-0 left-0 -ml-8 flex pt-4 pr-2 sm:-ml-10 sm:pr-4">
            <button id="btnClose" type="button" class="rounded-md text-gray-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-white" onclick="closeClick()">
