<div class="max-w-6xl mx-auto">
    <div class="flex justify-center">
        <div class="grid md:justify-start md:space-x-10 px-4">
            <main class="max-w-6xl mt-4 lg:mt-10 space-y-6">
                    ...
                    <div>
                        <article class='transition-colors duration-300 hover:bg-gray-100 border border-black border-opacity-0 hover:border-opacity-5 rounded-xl'>
                            <a href="{{route('reports_humidity', ['userID'=>auth()->user()->id])}}">
                                <img class="w-64" src="{{asset('images/water.png')}}" alt="humidity"/>
                    ...
                    <div>
                        <article class='transition-colors duration-300 hover:bg-gray-100 border border-black border-opacity-0 hover:border-opacity-5 rounded-xl'>
                            <a href="{{route('reports_humidity_soil', ['userID'=>auth()->user()->id])}}">
                                <img class="w-64" src="{{asset('images/soil.png')}}" alt="soil_humidity"/>
