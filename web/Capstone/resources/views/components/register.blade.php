        ...
        <main class="max-w-lg mx-auto mt-10 bg-gray-100 border-gray-200 p-6 rounded-xl">
            ...
            <form dusk="registerPage-register-form" method="POST" action="{{route('register')}}">
                ...
                <div class="mb-6">
                    ...
                    <input dusk="registerPage-register-form-username-input" class="border border-gray-400 p-2 w-full" type="text" name="username" id="username" value="{{old('username')}}" required>
                    @error('username')
                        <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                    @enderror
                </div>
